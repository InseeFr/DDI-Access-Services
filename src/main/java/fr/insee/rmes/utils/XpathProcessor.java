...
public interface XpathProcessor {
	...
	/**
	 * Converts an XML fragment represented as a String to a DOM Node
	 * representation
	 * 
	 * @param xml
	 * @return
	...
	/**
	 * Converts an XML fragment represented as a DOM Node element to its String
	 * representation
	 * 
	 * @param node
	 * @return
