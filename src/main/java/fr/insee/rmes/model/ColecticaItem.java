...
import fr.insee.rmes.utils.XpathProcessor;
import fr.insee.rmes.utils.XpathProcessorImpl;
...
/**
 * { "VersionRationale": { "property1": "string", "property2": "string" },
 * "ItemType": "string", "AgencyId": "string", "Version": 0, "Identifier":
 * "string", "Item": "string", "Notes": [ {} ], "VersionDate":
 * "2017-09-14T09:12:41Z", "VersionResponsibility": "string", "IsPublished":
 * true, "IsDeprecated": true, "IsProvisional": true, "ItemFormat": "string" }
 */
public class ColecticaItem {
	...
	public DDIItemType getType() throws Exception {
